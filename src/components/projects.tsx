...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      description:
        "An application to programmtically generate war deck sets in Clash Royale. It works by scraping RoyaleAPI for meta deck sets, using the Supercell API to get player card levels, and running an algorithm to determine the best deck combinations. Features both a command-line interface and discord integration. Formerly depoyed via GCP but discontinued after the card evolution update rendered my algorithm logic obsolete.",
      technologies: [
  ...
  return (
    <Parallax className="flex min-h-screen flex-col" speed={-30}>
      <div
        id="projects"
      ...
      <div className="-mt-1 grow bg-gradient-to-b from-sky-500 to-sky-700 dark:from-sky-800 dark:to-sky-950">
        <h2 className="mx-auto mb-16 max-w-[95%] animate-text bg-[linear-gradient(-225deg,_#881337_0%,#f97316_30%,_#dc2626_70%,_#fef08a_100%)] bg-[200%_auto] bg-clip-text text-center text-4xl leading-[2.25rem] text-transparent sm:mb-24 sm:max-w-[90%] sm:text-[4rem] sm:leading-[4rem] md:text-[5rem] md:leading-[5rem] lg:text-[6rem] lg:leading-[6rem] xl:mb-36 xl:text-[9rem] xl:leading-[9rem]">
          MY CERTIFICATIONS
        </h2>
        <div className="w-full overflow-hidden">
          <div className="mx-auto mb-72 grid w-11/12 grid-cols-12 gap-4">
            {projects.map((project) => (
              <Card
                key={project.id}
                className="relative col-span-12 bg-sky-200 p-1 md:col-span-6 xl:col-span-4 dark:bg-sky-950"
              >
